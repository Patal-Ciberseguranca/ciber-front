...
function Messages() {
  ...
  return (
    <div className='flex bg-background text-white'> 
        ...
        <div className={'bg-gray-700 h-screen p-5 pt-8 ${open ? "w-72" : "w-20"} duration-300 relative'}>

            <IoIosMenu className={'bg-white text-black text-4xl rounded-full -right-3 top-9 cursor-pointer'} onClick={() => setOpen(!open)}/>
